...
function resetProgress() {
  ...
  document.querySelector('.progress-header i').className = 'fas fa-download fa-bounce';
}
  ...
  eventSource.onmessage = (event) => {
    try {
      ...
      if (data.status === 'downloading') {
        ...
        progressSpeed.textContent = '';
        progressEta.textContent = '';
        document.querySelector('.progress-header h3').textContent = 'Tamamlandı!';
        document.querySelector('.progress-header i').className = 'fas fa-check-circle';
